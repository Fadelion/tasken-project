...
export default function Authenticated({ user, header, children }) {
    ...
    // Affiche les notifications toast en cas de message flash
    useEffect(() => {
        if (flash.success) {
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                {/* Affiche le lien "Administration" si l'utilisateur est un admin */}
                    ...
                    <div className="pt-4 pb-1 border-t border-gray-200">
                        <div className="px-4">
                            {user ? (
                                ...
                                <>
                                    <div className="font-medium text-base text-gray-800 text-red-500">Utilisateur inconnu</div>
