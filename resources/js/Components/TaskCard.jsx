        ...
        <div className={`bg-white overflow-hidden shadow-sm rounded-lg p-4 flex flex-col justify-between ${priorityClass(task.priority)}`}>
            ...
            <div className="mt-4">
                <div className="flex justify-between items-center text-xs text-gray-500 mb-1">
                    ...
                    <span>{task.completed_subtasks_count} / {task.subtasks_count} sous-tâches</span>
                </div>
            ...
            <div className="mt-4 flex justify-between items-center">
                ...
                <div className="flex items-center space-x-2">
                    <Link href={route('tasks.show', task.id)} className="text-sm text-gray-600 hover:text-gray-900 font-medium">Voir</Link>
                    <Link href={route('tasks.edit', task.id)} className="text-sm text-indigo-600 hover:text-indigo-900 font-medium">Modifier</Link>
